"""Inference-only Omega17-VL-Exp model"""
...
class Omega17ExpLLMModel(Omega17ExpModel):
...
class Omega17ExpLLMForCausalLM(Omega17ExpForCausalLM):
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        super(Omega17ExpForCausalLM, self).__init__()
        self.config = vllm_config.model_config.hf_config.text_config
        self.quant_config = vllm_config.quant_config
        self.model = Omega17ExpLLMModel(
...
@MULTIMODAL_REGISTRY.register_processor(
    Qwen3VLMultiModalProcessor,
    info=Omega17VLExpProcessingInfo,
...
class Omega17VLExpForConditionalGeneration(Qwen3VLForConditionalGeneration):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.language_model = Omega17ExpLLMForCausalLM(
