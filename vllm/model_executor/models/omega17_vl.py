"""Inference-only Omega17VL model"""
...
class Omega17_VisionPatchEmbed(nn.Module):
    def __init__(
        self,
        patch_size: int = 14,
...
class Omega17_VisionMLP(nn.Module):
    def __init__(
        self,
        in_features: int,
        hidden_features: int,
...
class Omega17_VisionBlock(nn.Module):
    def __init__(
        self,
        dim: int,
        num_heads: int,
...
class Omega17_VisionPatchMerger(nn.Module):
    def __init__(
        self,
        d_model: int,
        context_dim: int,
...
class Omega17_VisionTransformer(nn.Module):
    def __init__(
        self,
        ...
        self.patch_embed = Omega17_VisionPatchEmbed(
        ...
        self.merger = Omega17_VisionPatchMerger(
        ...
        if self.attn_backend not in {
            ...
            raise RuntimeError(
                f"Omega17-VL does not support {self.attn_backend} backend now."
            )
...
class Omega17VLProcessingInfo(Qwen2VLProcessingInfo):
    ...
    def get_max_video_tokens(
        ...
        # NOTE: By default in Omega17-VL, one video token is converted to
...
class Omega17VLDummyInputsBuilder(BaseDummyInputsBuilder[Omega17VLProcessingInfo]):
    ...
    def get_dummy_mm_data(
        ...
        # NOTE: we need to do this check here since Omega17-VL resizes video
...
class Omega17VLMultiModalProcessor(BaseMultiModalProcessor[Omega17VLProcessingInfo]):
...
class Omega17LLMModel(Qwen3Model):
...
class Omega17LLMForCausalLM(Qwen3ForCausalLM):
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.model = Omega17LLMModel(vllm_config=vllm_config, prefix=prefix)
...
@MULTIMODAL_REGISTRY.register_processor(
    Omega17VLMultiModalProcessor,
    info=Omega17VLProcessingInfo,
    dummy_inputs=Omega17VLDummyInputsBuilder,
)
class Omega17VLForConditionalGeneration(
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = "model"):
        ...
        if not multimodal_config.get_limit_per_prompt(
            ...
            self.visual = Omega17_VisionTransformer(
        ...
        self.language_model = Omega17LLMForCausalLM(
    ...
    def forward(
        ...
        **kwargs: object,
        ...
        """Run forward pass for Omega17VL.
        ...
        Args:
            ...
            positions: Flattened (concatenated) position ids corresponding to a
                batch.
                **NOTE**: If mrope is enabled (default setting for Omega17VL
